...
class TrackLoader {
 public:
   ...
   */
  static Track createOvalTrack(double length = 50.0, double width = 3.0, double cone_spacing = 5.0);
   ...
   * @return Generated track
   */
  static Track createSkidpadTrack(double radius = 9.125, double cone_spacing = 3.0);
