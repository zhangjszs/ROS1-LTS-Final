...
void TireModel::calculateForces(double slip_ratio, double slip_angle, double Fz, double& Fx,
                                double& Fy) const {
...
double TireModel::magicFormula(double slip, double B, double C, double D, double E) const {
