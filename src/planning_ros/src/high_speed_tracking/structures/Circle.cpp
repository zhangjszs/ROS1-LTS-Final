...
Circle::Circle(const Node& p0, const Node& p1, const Node& p2) {
  ...
  const double mGlobal =
      p1.pointGlobal().x * p1.pointGlobal().x - p0.pointGlobal().x * p0.pointGlobal().x +
      p1.pointGlobal().y * p1.pointGlobal().y - p0.pointGlobal().y * p0.pointGlobal().y;
  const double uGlobal =
      p2.pointGlobal().x * p2.pointGlobal().x - p0.pointGlobal().x * p0.pointGlobal().x +
  ...
  this->centerGlobal_.x = ((p2.pointGlobal().y - p0.pointGlobal().y) * mGlobal +
                           (p0.pointGlobal().y - p1.pointGlobal().y) * uGlobal) *
                          sGlobal;
  this->centerGlobal_.y = ((p0.pointGlobal().x - p2.pointGlobal().x) * mGlobal +
                           (p1.pointGlobal().x - p0.pointGlobal().x) * uGlobal) *
                          sGlobal;
