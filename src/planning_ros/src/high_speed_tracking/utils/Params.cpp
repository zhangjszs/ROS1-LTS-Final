...
Params::Params(ros::NodeHandle *const nh) {
  ...
  nh->param<std::string>(ns + "/stop_topic",main.stop_topic,"/stopTheCar");
  ...
  nh->param<int>(ns + "/number_of_stopped_turns",main.number_of_stopped_turns,3);
  nh->param<int>(ns + "/the_mode_of_partial_path",main.the_mode_of_partial_path,4);
  nh->param<int>(ns + "/the_mode_of_full_path",main.the_mode_of_full_path,5);
