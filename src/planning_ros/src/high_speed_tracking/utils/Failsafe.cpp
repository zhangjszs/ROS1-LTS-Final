...
template <typename T>
void Failsafe<T>::initGeneral(const T& params, const double& safetyFactor,
...
template void Failsafe<Params::WayComputer::Search>::initGeneral(const Params::WayComputer::Search&,
