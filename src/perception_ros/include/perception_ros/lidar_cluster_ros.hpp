...
class LidarClusterRos {
 ...
 private:
  using ApproxFusionSyncPolicy =
      message_filters::sync_policies::ApproximateTime<sensor_msgs::PointCloud2,
                                                      autodrive_msgs::HUAT_VisionDetections>;
  using ExactFusionSyncPolicy =
  ...
  std::unique_ptr<message_filters::Subscriber<autodrive_msgs::HUAT_VisionDetections>>
      fusion_vision_sub_;
