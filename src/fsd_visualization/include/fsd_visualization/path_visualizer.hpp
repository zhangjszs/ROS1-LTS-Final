...
class PathVisualizer {
 ...
 private:
  ...
  visualization_msgs::MarkerArray createPathMarkers(const autodrive_msgs::HUAT_PathLimits& msg,
                                                    const std::string& ns,
                                                    const std::array<float, 4>& color);

  visualization_msgs::MarkerArray createBoundaryMarkers(const autodrive_msgs::HUAT_PathLimits& msg);
