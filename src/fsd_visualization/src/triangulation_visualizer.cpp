...
void TriangulationVisualizer::vizCallback(const autodrive_msgs::HUAT_HighSpeedViz::ConstPtr& msg) {
  ...
  if (show_midpoints_) {
    ...
    all_midpoints.insert(all_midpoints.end(), msg->edge_midpoints.begin(),
                         msg->edge_midpoints.end());
    all_midpoints.insert(all_midpoints.end(), msg->triangle_edge_midpoints.begin(),
                         msg->triangle_edge_midpoints.end());
